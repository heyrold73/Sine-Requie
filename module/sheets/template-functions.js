...
const component = async (
    callback,
    { componentData = null, allowedComponents = null, isDynamicTable = false, entity = null }
) => {
    let permissionList = {};
...
const modifiers = async (callback, blocks) => {
                    ...
                    callback: (html) => {
                        ...
                        for (let block of modifierBlocks) {
                            ...
                            for (let modifierElt of modifierEltList) {
                                let modifierId =
                                    $(modifierElt).find('.custom-system-modifier-id')?.val() ||
    ...
    <td>
        <input type="text" class="custom-system-modifier-key" />
    </td>
    <td>
